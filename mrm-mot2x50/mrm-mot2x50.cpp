...
*/
Mrm_mot2x50::Mrm_mot2x50(ESP32CANBus *esp32CANBusSingleton, BluetoothSerial * hardwareSerial) : MotorGroup(esp32CANBusSingleton, 4, "Mot4x3.6"){
...
*/
void Mrm_mot2x50::add(bool isReversed, bool isLeft, char * deviceName)
{
	MotorGroup::add(deviceName, CAN_ID_MOT2X50_0_MOTOR0_IN, CAN_ID_MOT2X50_0_MOTOR0_OUT, CAN_ID_MOT2X50_0_MOTOR1_IN, CAN_ID_MOT2X50_0_MOTOR1_OUT,
