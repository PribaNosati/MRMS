...
#define swapAda(a, b) { int16_t t = a; a = b; b = t; }
...
Adafruit_LEDBackpack::Adafruit_LEDBackpack(bool isI2C0) {
	_isI2C0 = isI2C0;
}
...
void Adafruit_LEDBackpack::begin(uint8_t _addr = 0x70) {
  ...
  //if (_isI2C0) {
	 // //Serial.println("Using I2C 0");
	 // Wire.begin();
  //}
  //else {
	 // //Serial.println("Using I2C 1");
	 // Wire1.begin();
  //}
...
Adafruit_BicolorMatrix::Adafruit_BicolorMatrix(bool isI2C0) : Adafruit_LEDBackpack(isI2C0), Adafruit_GFX(8, 8){
}
