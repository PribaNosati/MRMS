...
void setup() {
  ...
  for (uint8_t i = 0; i < 8; i++)
    can.messageSend(0x360 + 2 * i, 1, data);     // 0x360 is sensor 1 of the first range, 0x362 sensor 2, etc. This loop will start all the sensors that are connected to the bus.
}
